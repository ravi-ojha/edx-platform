...
from lms.djangoapps.instructor_task.config.models import GradeReportsBatchSizeSetting
...
admin.site.register(GradeReportsBatchSizeSetting, ConfigurationModelAdmin)